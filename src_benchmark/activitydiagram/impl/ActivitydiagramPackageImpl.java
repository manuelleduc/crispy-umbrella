...
import activitydiagram.Expression_Aspect;
...
public class ActivitydiagramPackageImpl extends EPackageImpl implements ActivitydiagramPackage {
	 ...
	 * @generated
	 */
	private EClass expression_AspectEClass = null;
	 ...
	 * @generated
	 */
	public EClass getExpression_Aspect() {
		return expression_AspectEClass;
	}
	...
	public void createPackageContents() {
		...
		expression_AspectEClass = createEClass(EXPRESSION_ASPECT);
	...
	public void initializePackageContents() {
		...
		booleanExpression_AspectEClass.getESuperTypes().add(this.getExpression_Aspect());
		...
		integerExpression_AspectEClass.getESuperTypes().add(this.getExpression_Aspect());
		...
		expression_AspectEClass.getESuperTypes().add(theActivitydiagramoaPackage.getExpression());
		...
		initEReference(getInputValue_Variable(), theActivitydiagramoaPackage.getVariable(), null, "variable", null, 0, 1, InputValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(expression_AspectEClass, Expression_Aspect.class, "Expression_Aspect", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
