...
public class ActivitydiagramActivitydiagramAction_AspectOperation implements activitydiagram.activitydiagram.algebra.operation.ActivitydiagramActivitydiagramAction_AspectOperation { 
	...
	private final ActivitydiagramActivitydiagramActivityNode_AspectOperation delegateActivityNode_Aspect;
...
return this.delegateActivityNode_Aspect.isReady() && this.hasOffers();
	}
	public void run() {
