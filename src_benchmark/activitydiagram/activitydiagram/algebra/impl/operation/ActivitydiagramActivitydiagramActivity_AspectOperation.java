...
import activitydiagramoa.activitydiagram.algebra.operation.ActivitydiagramoaActivitydiagramActivityNodeOperation;

public class ActivitydiagramActivitydiagramActivity_AspectOperation implements
		activitydiagram.activitydiagram.algebra.operation.ActivitydiagramActivitydiagramActivity_AspectOperation {

	private class EListCollector<T> implements
			java.util.stream.Collector<T, org.eclipse.emf.common.util.EList<T>, org.eclipse.emf.common.util.EList<T>> {
	...
	public ActivitydiagramActivitydiagramActivity_AspectOperation(final activitydiagram.Activity_Aspect self,
	...
	public activitydiagramoa.ActivityNode selectNextNode(
			org.eclipse.emf.common.util.EList<activitydiagramoa.ActivityNode> activityNodes) {
	...
	public org.eclipse.emf.common.util.EList<activitydiagramoa.ActivityNode> getEnabledNodes() {
		...
		for (activitydiagramoa.ActivityNode node : self.getNodes()) {
			ActivitydiagramoaActivitydiagramActivityNodeOperation sem = algebra.$(node);
			Boolean ready = sem.isReady();
			if (ready) {
	...
	public void runNodes() {
		for (activitydiagramoa.ActivityNode node : self.getNodes()) {
			ActivitydiagramoaActivitydiagramActivityNodeOperation $ = algebra.$(node);
			$.run();
		}
	}
