...
public class ActivitydiagramSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ActivitydiagramPackage.INTEGER_COMPARISON_EXPRESSION_ASPECT: {
				...
				if (result == null) result = caseExpression_Aspect(integerComparisonExpression_Aspect);
			...
			case ActivitydiagramPackage.BOOLEAN_BINARY_EXPRESSION_ASPECT: {
				...
				if (result == null) result = caseExpression_Aspect(booleanBinaryExpression_Aspect);
			...
			case ActivitydiagramPackage.BOOLEAN_EXPRESSION_ASPECT: {
				...
				if (result == null) result = caseExpression_Aspect(booleanExpression_Aspect);
			...
			case ActivitydiagramPackage.INTEGER_EXPRESSION_ASPECT: {
				...
				if (result == null) result = caseExpression_Aspect(integerExpression_Aspect);
			...
			case ActivitydiagramPackage.BOOLEAN_UNARY_EXPRESSION_ASPECT: {
				...
				if (result == null) result = caseExpression_Aspect(booleanUnaryExpression_Aspect);
				if (result == null) result = caseExpression(booleanUnaryExpression_Aspect);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActivitydiagramPackage.EXPRESSION_ASPECT: {
				Expression_Aspect expression_Aspect = (Expression_Aspect)theEObject;
				T result = caseExpression_Aspect(expression_Aspect);
				if (result == null) result = caseExpression(expression_Aspect);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ActivitydiagramPackage.INTEGER_CALCULATION_EXPRESSION_ASPECT: {
				...
				if (result == null) result = caseExpression_Aspect(integerCalculationExpression_Aspect);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Expression Aspect</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Expression Aspect</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseExpression_Aspect(Expression_Aspect object) {
		return null;
	}
