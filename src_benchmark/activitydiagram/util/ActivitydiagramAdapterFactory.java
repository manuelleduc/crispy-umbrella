...
public class ActivitydiagramAdapterFactory extends AdapterFactoryImpl {
	...
	protected ActivitydiagramSwitch<Adapter> modelSwitch =
		new ActivitydiagramSwitch<Adapter>() {
			...
			@Override
			public Adapter caseExpression_Aspect(Expression_Aspect object) {
				return createExpression_AspectAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link activitydiagram.Expression_Aspect <em>Expression Aspect</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createExpression_AspectAdapter() {
		return null;
	}
