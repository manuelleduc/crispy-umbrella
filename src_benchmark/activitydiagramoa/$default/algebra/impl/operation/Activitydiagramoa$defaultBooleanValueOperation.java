...
public class Activitydiagramoa$defaultBooleanValueOperation implements activitydiagramoa.$default.algebra.operation.Activitydiagramoa$defaultBooleanValueOperation { 
	...
	public Activitydiagramoa$defaultBooleanValueOperation(final activitydiagramoa.BooleanValue self, Object algebra) {
		this.self = self;
	}
