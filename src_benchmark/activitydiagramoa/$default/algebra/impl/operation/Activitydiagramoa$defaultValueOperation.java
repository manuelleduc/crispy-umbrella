...
public class Activitydiagramoa$defaultValueOperation implements activitydiagramoa.$default.algebra.operation.Activitydiagramoa$defaultValueOperation { 
	...
	public Activitydiagramoa$defaultValueOperation(final activitydiagramoa.Value self, Object algebra) {
		this.self = self;
	}
