...
public class Activitydiagramoa$defaultIntegerValueOperation implements activitydiagramoa.$default.algebra.operation.Activitydiagramoa$defaultIntegerValueOperation { 
	...
	public Activitydiagramoa$defaultIntegerValueOperation(final activitydiagramoa.IntegerValue self, Object algebra) {
		this.self = self;
	}
