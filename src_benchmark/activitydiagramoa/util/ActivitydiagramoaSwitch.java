/**
 */
package activitydiagramoa.util;

import activitydiagramoa.*;
 ...
 * <!-- end-user-doc -->
 * @see activitydiagramoa.ActivitydiagramoaPackage
 * @generated
 */
public class ActivitydiagramoaSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static ActivitydiagramoaPackage modelPackage;
	 ...
	 * @generated
	 */
	public ActivitydiagramoaSwitch() {
		if (modelPackage == null) {
			modelPackage = ActivitydiagramoaPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ActivitydiagramoaPackage.ACTIVITY: {
			...
			case ActivitydiagramoaPackage.ACTIVITY_NODE: {
			...
			case ActivitydiagramoaPackage.ACTIVITY_EDGE: {
			...
			case ActivitydiagramoaPackage.CONTROL_FLOW: {
			...
			case ActivitydiagramoaPackage.CONTROL_NODE: {
			...
			case ActivitydiagramoaPackage.EXECUTABLE_NODE: {
			...
			case ActivitydiagramoaPackage.ACTION: {
			...
			case ActivitydiagramoaPackage.OPAQUE_ACTION: {
			...
			case ActivitydiagramoaPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActivitydiagramoaPackage.INITIAL_NODE: {
			...
			case ActivitydiagramoaPackage.FINAL_NODE: {
			...
			case ActivitydiagramoaPackage.ACTIVITY_FINAL_NODE: {
			...
			case ActivitydiagramoaPackage.FORK_NODE: {
			...
			case ActivitydiagramoaPackage.JOIN_NODE: {
			...
			case ActivitydiagramoaPackage.MERGE_NODE: {
			...
			case ActivitydiagramoaPackage.DECISION_NODE: {
			...
			case ActivitydiagramoaPackage.VARIABLE: {
				Variable variable = (Variable)theEObject;
				T result = caseVariable(variable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActivitydiagramoaPackage.INTEGER_VARIABLE: {
			...
			case ActivitydiagramoaPackage.BOOLEAN_VARIABLE: {
			...
			case ActivitydiagramoaPackage.VALUE: {
				Value value = (Value)theEObject;
				T result = caseValue(value);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActivitydiagramoaPackage.BOOLEAN_VALUE: {
			...
			case ActivitydiagramoaPackage.INTEGER_VALUE: {
			...
			case ActivitydiagramoaPackage.EXPRESSION: {
				Expression expression = (Expression)theEObject;
				T result = caseExpression(expression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActivitydiagramoaPackage.INTEGER_EXPRESSION: {
			...
			case ActivitydiagramoaPackage.BOOLEAN_EXPRESSION: {
			...
			case ActivitydiagramoaPackage.INTEGER_CALCULATION_EXPRESSION: {
			...
			case ActivitydiagramoaPackage.INTEGER_COMPARISON_EXPRESSION: {
			...
			case ActivitydiagramoaPackage.BOOLEAN_UNARY_EXPRESSION: {
			...
			case ActivitydiagramoaPackage.BOOLEAN_BINARY_EXPRESSION: {
