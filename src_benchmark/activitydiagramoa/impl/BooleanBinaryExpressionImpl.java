...
import activitydiagramoa.BooleanBinaryOperator;
 ...
 * </p>
 * <ul>
 *   <li>{@link activitydiagramoa.impl.BooleanBinaryExpressionImpl#getOperand1 <em>Operand1</em>}</li>
 *   <li>{@link activitydiagramoa.impl.BooleanBinaryExpressionImpl#getOperand2 <em>Operand2</em>}</li>
 *   <li>{@link activitydiagramoa.impl.BooleanBinaryExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanBinaryExpressionImpl extends BooleanExpressionImpl implements BooleanBinaryExpression {
	...
	protected EClass eStaticClass() {
		return ActivitydiagramoaPackage.Literals.BOOLEAN_BINARY_EXPRESSION;
	}
		...
		if (operand1 != null && operand1.eIsProxy()) {
			...
			if (operand1 != oldOperand1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivitydiagramoaPackage.BOOLEAN_BINARY_EXPRESSION__OPERAND1, oldOperand1, operand1));
			}
		}
		return operand1;
	}
	...
	public void setOperand1(BooleanVariable newOperand1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivitydiagramoaPackage.BOOLEAN_BINARY_EXPRESSION__OPERAND1, oldOperand1, operand1));
	}
	...
	public BooleanVariable getOperand2() {
		if (operand2 != null && operand2.eIsProxy()) {
			...
			if (operand2 != oldOperand2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivitydiagramoaPackage.BOOLEAN_BINARY_EXPRESSION__OPERAND2, oldOperand2, operand2));
			}
		}
		return operand2;
	}
	...
	public void setOperand2(BooleanVariable newOperand2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivitydiagramoaPackage.BOOLEAN_BINARY_EXPRESSION__OPERAND2, oldOperand2, operand2));
	}
	...
	public void setOperator(BooleanBinaryOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivitydiagramoaPackage.BOOLEAN_BINARY_EXPRESSION__OPERATOR, oldOperator, operator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivitydiagramoaPackage.BOOLEAN_BINARY_EXPRESSION__OPERAND1:
				if (resolve) return getOperand1();
				return basicGetOperand1();
			case ActivitydiagramoaPackage.BOOLEAN_BINARY_EXPRESSION__OPERAND2:
				if (resolve) return getOperand2();
				return basicGetOperand2();
			case ActivitydiagramoaPackage.BOOLEAN_BINARY_EXPRESSION__OPERATOR:
				return getOperator();
		}
