...
import activitydiagramoa.BooleanUnaryOperator;
...
import activitydiagramoa.IntegerComparisonOperator;
 ...
 * @generated
 */
public class ActivitydiagramoaPackageImpl extends EPackageImpl implements ActivitydiagramoaPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see activitydiagramoa.ActivitydiagramoaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ActivitydiagramoaPackageImpl() {
		super(eNS_URI, ActivitydiagramoaFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ActivitydiagramoaPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ActivitydiagramoaPackage init() {
		if (isInited) return (ActivitydiagramoaPackage)EPackage.Registry.INSTANCE.getEPackage(ActivitydiagramoaPackage.eNS_URI);

		// Obtain or create and register package
		ActivitydiagramoaPackageImpl theActivitydiagramoaPackage = (ActivitydiagramoaPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ActivitydiagramoaPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ActivitydiagramoaPackageImpl());
		...
		theActivitydiagramoaPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ActivitydiagramoaPackage.eNS_URI, theActivitydiagramoaPackage);
		return theActivitydiagramoaPackage;
	}
	 ...
	 * @generated
	 */
	public ActivitydiagramoaFactory getActivitydiagramoaFactory() {
		return (ActivitydiagramoaFactory)getEFactoryInstance();
	}
