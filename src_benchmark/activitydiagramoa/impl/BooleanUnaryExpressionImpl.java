 ...
 * </p>
 * <ul>
 *   <li>{@link activitydiagramoa.impl.BooleanUnaryExpressionImpl#getOperand <em>Operand</em>}</li>
 *   <li>{@link activitydiagramoa.impl.BooleanUnaryExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanUnaryExpressionImpl extends BooleanExpressionImpl implements BooleanUnaryExpression {
	...
	protected EClass eStaticClass() {
		return ActivitydiagramoaPackage.Literals.BOOLEAN_UNARY_EXPRESSION;
	}
		...
		if (operand != null && operand.eIsProxy()) {
			...
			if (operand != oldOperand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivitydiagramoaPackage.BOOLEAN_UNARY_EXPRESSION__OPERAND, oldOperand, operand));
			}
		}
		return operand;
	}
	...
	public void setOperand(BooleanVariable newOperand) {
		...
		operand = newOperand;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivitydiagramoaPackage.BOOLEAN_UNARY_EXPRESSION__OPERAND, oldOperand, operand));
	}
	...
	public void setOperator(BooleanUnaryOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivitydiagramoaPackage.BOOLEAN_UNARY_EXPRESSION__OPERATOR, oldOperator, operator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivitydiagramoaPackage.BOOLEAN_UNARY_EXPRESSION__OPERAND:
				if (resolve) return getOperand();
				return basicGetOperand();
			case ActivitydiagramoaPackage.BOOLEAN_UNARY_EXPRESSION__OPERATOR:
				return getOperator();
		}
