 ...
 * </p>
 * <ul>
 *   <li>{@link activitydiagramoa.impl.IntegerComparisonExpressionImpl#getAssignee <em>Assignee</em>}</li>
 *   <li>{@link activitydiagramoa.impl.IntegerComparisonExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerComparisonExpressionImpl extends IntegerExpressionImpl implements IntegerComparisonExpression {
	...
	protected EClass eStaticClass() {
		return ActivitydiagramoaPackage.Literals.INTEGER_COMPARISON_EXPRESSION;
	}
		...
		if (assignee != null && assignee.eIsProxy()) {
			...
			if (assignee != oldAssignee) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivitydiagramoaPackage.INTEGER_COMPARISON_EXPRESSION__ASSIGNEE, oldAssignee, assignee));
			}
		}
		return assignee;
	}
	...
	public void setAssignee(BooleanVariable newAssignee) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivitydiagramoaPackage.INTEGER_COMPARISON_EXPRESSION__ASSIGNEE, oldAssignee, assignee));
	}
	...
	public void setOperator(IntegerComparisonOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivitydiagramoaPackage.INTEGER_COMPARISON_EXPRESSION__OPERATOR, oldOperator, operator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivitydiagramoaPackage.INTEGER_COMPARISON_EXPRESSION__ASSIGNEE:
				if (resolve) return getAssignee();
				return basicGetAssignee();
			case ActivitydiagramoaPackage.INTEGER_COMPARISON_EXPRESSION__OPERATOR:
				return getOperator();
		}
