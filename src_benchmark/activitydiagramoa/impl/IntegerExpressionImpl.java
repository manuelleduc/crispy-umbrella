 ...
 * </p>
 * <ul>
 *   <li>{@link activitydiagramoa.impl.IntegerExpressionImpl#getOperand2 <em>Operand2</em>}</li>
 *   <li>{@link activitydiagramoa.impl.IntegerExpressionImpl#getOperand1 <em>Operand1</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class IntegerExpressionImpl extends ExpressionImpl implements IntegerExpression {
	...
	protected EClass eStaticClass() {
		return ActivitydiagramoaPackage.Literals.INTEGER_EXPRESSION;
	}
		...
		if (operand2 != null && operand2.eIsProxy()) {
			...
			if (operand2 != oldOperand2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivitydiagramoaPackage.INTEGER_EXPRESSION__OPERAND2, oldOperand2, operand2));
			}
		}
		return operand2;
	}
	...
	public void setOperand2(IntegerVariable newOperand2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivitydiagramoaPackage.INTEGER_EXPRESSION__OPERAND2, oldOperand2, operand2));
	}
	...
	public IntegerVariable getOperand1() {
		if (operand1 != null && operand1.eIsProxy()) {
			...
			if (operand1 != oldOperand1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivitydiagramoaPackage.INTEGER_EXPRESSION__OPERAND1, oldOperand1, operand1));
			}
		}
		return operand1;
	}
	...
	public void setOperand1(IntegerVariable newOperand1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivitydiagramoaPackage.INTEGER_EXPRESSION__OPERAND1, oldOperand1, operand1));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivitydiagramoaPackage.INTEGER_EXPRESSION__OPERAND2:
				if (resolve) return getOperand2();
				return basicGetOperand2();
			case ActivitydiagramoaPackage.INTEGER_EXPRESSION__OPERAND1:
