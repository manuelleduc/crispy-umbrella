 ...
 * </p>
 * <ul>
 *   <li>{@link activitydiagramoa.impl.BooleanExpressionImpl#getAssignee <em>Assignee</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BooleanExpressionImpl extends ExpressionImpl implements BooleanExpression {
	...
	protected EClass eStaticClass() {
		return ActivitydiagramoaPackage.Literals.BOOLEAN_EXPRESSION;
	}
		...
		if (assignee != null && assignee.eIsProxy()) {
			...
			if (assignee != oldAssignee) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivitydiagramoaPackage.BOOLEAN_EXPRESSION__ASSIGNEE, oldAssignee, assignee));
			}
		}
		return assignee;
	}
	...
	public void setAssignee(BooleanVariable newAssignee) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivitydiagramoaPackage.BOOLEAN_EXPRESSION__ASSIGNEE, oldAssignee, assignee));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivitydiagramoaPackage.BOOLEAN_EXPRESSION__ASSIGNEE:
