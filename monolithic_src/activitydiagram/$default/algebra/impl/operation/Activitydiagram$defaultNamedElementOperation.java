...
public class Activitydiagram$defaultNamedElementOperation implements activitydiagram.$default.algebra.operation.Activitydiagram$defaultNamedElementOperation { 
	...
	public Activitydiagram$defaultNamedElementOperation(final activitydiagram.NamedElement self, Object algebra) {
		this.self = self;
	}
