...
public class Activitydiagram$defaultBooleanValueOperation implements activitydiagram.$default.algebra.operation.Activitydiagram$defaultBooleanValueOperation { 
	...
	public Activitydiagram$defaultBooleanValueOperation(final activitydiagram.BooleanValue self, Object algebra) {
		this.self = self;
	}
