...
public class Activitydiagram$defaultIntegerValueOperation implements activitydiagram.$default.algebra.operation.Activitydiagram$defaultIntegerValueOperation { 
	...
	public Activitydiagram$defaultIntegerValueOperation(final activitydiagram.IntegerValue self, Object algebra) {
		this.self = self;
	}
